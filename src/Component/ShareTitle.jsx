...
const ShareTitle = ({ opactityTitle, Title }) => {
    return (
        <div className='flex-row relative text-center'>
            <h2 className='md:text-8xl text-6xl font-bold opacity-10 md:tracking-[20px] tracking-[6px]   text-light mb-0 mx-auto'>{opactityTitle}</h2>
            <div className=' absolute md:left-96 left-24 md:bottom-2 -bottom-1 '>
